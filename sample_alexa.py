...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the Alexa Skills Kit - MINT. " \
                    "Please ask me questions about your expenses, like, " \
                    "what's my income, what's my expense"
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Please ask me questions about your expenses, by saying, " \
                    "what's my income, what's my expense"
...
def handle_session_end_request():
    ...
    speech_output = "Thank you for trying the Alexa Skills Kit MINT. " \
                    "Have a nice day! "
